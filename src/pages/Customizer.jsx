...
// ! API KEY EXPIRED, NEED A NEW ONE FOR THE AI
const Customizer = () => {
  ...
  const handleSubmit = async (type) => {
    ...
    try {
      ...
      alert("It went through but my trial is expired. 👍");
    } catch (error) {
      alert(error);
    } finally {
      setActiveEditorTab("");
  ...
  // Implement user files as textures and logos
  ...
  const handleActiveFilterTab = (tabName) => {
    ...
    // set active filter tab (update the state)
